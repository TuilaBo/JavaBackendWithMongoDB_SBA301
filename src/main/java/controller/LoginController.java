...
public class LoginController {
    ...
    public ResponseEntity<Map<String, Object>> register(@RequestBody RegisterRequest registerRequest) {
        try {
            ...
            // Lấy roleName từ roleId
            String roleName = "USER";
            if (createdAccount.getRoleId() != null) {
                Role role = roleService.getRoleById(createdAccount.getRoleId());
                if (role != null) {
                    roleName = role.getRoleName();
                }
            }
    ...
    public ResponseEntity<Map<String, Object>> updateUserRole(@PathVariable String userId, @RequestBody UpdateUserRoleRequest request) {
        try {
            ...
            Account updatedAccount = systemAccountService.updateUserRole(userId, request.getRoleId());
            Map<String, Object> response = new HashMap<>();
            ...
            // Lấy roleName từ roleId
            String roleName = "USER";
            if (updatedAccount.getRoleId() != null) {
                Role updatedRole = roleService.getRoleById(updatedAccount.getRoleId());
                if (updatedRole != null) {
